...
<body>
    ...
    <main>
    <h2>Paint War DEV LOG 3</h2>
        <h3>Ajout d'armes à feu dans Paint War<h3>
        <p>
        ...
        <p>
        Premier dev log ! C'est la première fois depuis que j'ai pris la parole pour le mariage d'un ami que je parle à autant de monde ! Ça m'émoustille un peu... 
        Bref ! Nous avons ajouté des couteaux, sabres, des bakootas et des katanas dans le jeu. Pour ne pas heurter la sensibilité des plus jeunes, les lames sont en mousse.
        </p>
    </main>
    <footer>
